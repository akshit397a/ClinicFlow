  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-2xs transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-sm hover:border-[#d1d5db]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-[#6b7280]">
              {isProvider ? 'My Intake Today' : "Today's Clinic Intake"}
            </span>
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-blue-50 text-blue-600 transition-transform duration-200 hover:scale-105">
        ...
        <div className="rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-2xs transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-sm hover:border-[#d1d5db]">
          <div className="flex items-center justify-between">
            ...
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 transition-transform duration-200 hover:scale-105">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <div className="rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-2xs transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-sm hover:border-[#d1d5db]">
          <div className="flex items-center justify-between">
            ...
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-violet-50 text-violet-600 transition-transform duration-200 hover:scale-105">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <div
          className={`rounded-xl border p-4 shadow-2xs transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-sm ${
